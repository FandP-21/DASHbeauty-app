...
final Map<String, WidgetBuilder> routes = {
  //SplashScreen.routeName: (context) => SplashScreen(token),
  ...
  ResellerSignInScreen.routeName: (context) => ResellerSignInScreen(),
  ResellerSignUpScreen.routeName: (context) => ResellerSignUpScreen(),
