...
class ResellerSignUpForm extends StatefulWidget {
  @override
  _ResellerSignUpFormState createState() => _ResellerSignUpFormState();
}

class _ResellerSignUpFormState extends State<ResellerSignUpForm> {
